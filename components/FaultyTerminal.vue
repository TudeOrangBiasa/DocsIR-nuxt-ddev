...
void main() {
    ...
    // Make background completely black, keep only the green dots/chars
...
const init = () => {
  ...
  const update = (t: number) => {
    ...
    if (props.pageLoadAnimation && loadAnimationStart > 0 && program) {
