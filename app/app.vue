...
const openPresentationModal = () => {
  console.log('Opening presentation modal - before:', showPresentationModal.value)
  showPresentationModal.value = true
  console.log('Opening presentation modal - after:', showPresentationModal.value)
}

const closePresentationModal = () => {
  console.log('Closing presentation modal - before:', showPresentationModal.value)
  showPresentationModal.value = false
  console.log('Closing presentation modal - after:', showPresentationModal.value)
}
</script>
...
<template>
  <div class="min-h-screen relative ">
    ...
    <div class="fixed inset-0 z-0">
      ...
      >
        <div
          ...
          style="height: 80dvh; aspect-ratio: 2 / 1; border-radius: 100%;"
        >
          <!-- Main radial gradient -->
          <div
        class="w-80dvh aspect-[2/1] rounded-full"
    ...
    <main class="relative z-10 flex flex-col items-center justify-center flex-grow px-4 text-center min-h-screen">
      <SearchHeader />
      ...
      <div class="my-8">
        <GlassSurface
          ...
          :blur-amount="20"
          class="hover:shadow-2xl transition-all duration-300 hover:scale-105"
        >
          <button
            @click="openPresentationModal"
            class="w-full h-full flex items-center justify-center space-x-3 text-blue-200 hover:text-blue-100 transition-colors group cursor-pointer"
          >
            <div class="text-2xl group-hover:scale-110 transition-transform">🎬</div>
            <span class="text-lg font-semibold">Presentation</span>
            <div class="w-2 h-2 bg-blue-400 rounded-full animate-pulse opacity-75 group-hover:opacity-100"></div>
          </button>
        </GlassSurface>
      </div>
    ...
    <!-- MODALS CONTAINER -->
    <!-- All modals are moved here to ensure they are at the top of the DOM tree -->
